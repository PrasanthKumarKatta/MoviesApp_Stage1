...
public class MoviesContentProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.kpcode4u.prasanthkumar.moviesapp";
    public static final Uri BASE_URI = Uri.parse("content://" + AUTHORITY );
    public static final String PATH = FavoriteContract.FavoriteEntry.TABLE_NAME;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (mt == TASK){
            long res = db.delete(FavoriteContract.FavoriteEntry.TABLE_NAME,"id=" + Integer.parseInt(selection), null );
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        db = favoriteMoviesSQLiteDB.getWritableDatabase();
        if (mt == TASK){
            long result = db.insert(FavoriteContract.FavoriteEntry.TABLE_NAME,null,values);
